export default {
  ...
  'BackTen': ['arrow', 'backward', 'rewind', 'player', 'seconds', 'skip'],
  ...
  'Down': ['arrow', 'expand', 'direction', 'drop'],
  ...
  'ForwardTen': ['arrow', 'seconds', 'player', 'skip'],
  ...
  'Refresh': ['arrow', 'backup', 'core', 'reload', 'repeat', 'pull', 'sync', 'update'],
  ...
  'Save': ['arrow', 'floppy', 'store', 'storage'],
  ...
  'Up': ['arrow', 'collapse', 'direction'],
  'Update': ['arrow', 'change', 'core', 'reload', 'refresh'],
  'Upgrade': ['arrow', 'circle'],
  ...
  'VmMaintenance': ['tool', 'vmware', 'wrench'],
  'Vmware': ['logo', 'virtual'],
  ...
  'Waypoint': ['arrow', 'cursor', 'compass', 'gps', 'location', 'navigation'],

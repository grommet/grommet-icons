export default {
  ...
  'Action': ['up4review', 'connect', 'plug'],
  'Actions': ['up4review', 'gear', 'sun'],
  ...
  'BusinessService': ['up4review', 'briefcase', 'services'],
  ...
  'ClearOption': ['up4review', 'paintbrush'],
  ...
  'Connect': ['up4review', 'network', 'plug'],
  'Connectivity': ['up4review', 'network', 'plug'],
  ...
  'Device': ['up4review', 'iot', 'technology', 'tv'],
  ...
  'Emergency': ['up4review', 'alert', 'asterisk'],
  'EmptyCircle': ['chart', 'donut'],
  'Erase': ['delete', 'eraser', 'remove'],
  'Escalaton': ['up4review', 'stairs', 'staircase', 'moving', 'transportation', 'person', 'up'],
  ...
  'Fan': ['up4review', 'air', 'cooling', 'ventilator'],
  ...
  'Impact': ['up4review', 'crash', 'explode'],
  ...
  'Local': ['up4review', 'flag', 'language', 'location', 'usa'],
  ...
  'Manual': ['up4review', 'stick', 'joystick'],
  ...
  'ObjectGroup': [''],
  'ObjectUngroup': [''],
  'OfflineStorage': ['up4review', 'backup', 'tape'],
  ...
  'Plan': ['up4review', 'calendar', 'checklist', 'schedule'],
  ...
  'Radial': ['up4review', 'circle', 'radio', 'off'],
  'RadialSelected': ['up4review', 'circle', 'radio', 'on'],
  ...
  'Schedule': ['up4review', 'agenda', 'appointment', 'calendar', 'checklist', 'month', 'plan'],
  ...
  'SearchAdvanced': ['up4review', 'find', 'lookup', 'magnifier', 'plus', 'zoom'],
  'Secure': ['closed', 'locked', 'security'],
  'Select': ['cursor', 'pointer', 'selection'],
  'Selection': ['up4review', 'column'],
  ...
  'Sort': ['up4review', 'bullets', 'list', 'items'],
  ...
  'ThreeDffects': ['up4review', '3d', 'cube', 'box'],

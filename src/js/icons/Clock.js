...
const Clock = forwardRef((props, ref) => (
  <StyledIcon ref={ref} viewBox="0 0 24 24" a11yTitle="Clock" {...props}>
    <path d="M12 6C12.5523 6 13 6.44772 13 7V11.5L16.5996 14.2002C17.0414 14.5315 17.131 15.1578 16.7998 15.5996C16.4685 16.0414 15.8422 16.131 15.4004 15.7998L11.4004 12.7998C11.1486 12.611 11 12.3148 11 12V7C11 6.44772 11.4477 6 12 6Z" fill="#555555"/>

...
var _default = exports["default"] = {
  ...
  AIGen: ['ai', 'sparkle', 'gen ai', 'generative', 'generative ai', 'artificial intelligence'],
  AIGenFill: ['ai', 'sparkle', 'gen ai', 'generative', 'generative ai', 'artificial intelligence'],
  ...
  HelpBook: ['contextual', 'help', 'learning', 'support'],
  ...
  StatusCriticalFill: ['error', 'halt', 'stop', 'warning'],
  StatusDisabled: ['off'],
  StatusDisabledFill: ['off'],
  StatusGood: ['accept', 'check', 'ok'],
  StatusGoodFill: ['accept', 'check', 'ok'],
  StatusInfo: ['faq', 'help', 'hint', 'information'],
  StatusInfoFill: ['faq', 'help', 'hint', 'information'],
  StatusPlaceholder: ['box'],
  StatusUnknown: ['question'],
  StatusUnknownFill: ['question'],
  StatusWarning: ['exclamation'],
  StatusWarningFill: ['exclamation'],
